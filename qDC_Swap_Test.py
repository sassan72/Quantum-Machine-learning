...
num_qubits = 7 # 2*log(feature_size) + 1(ancilla)
...
#dev = qml.device("default.qubit", wires=num_qubits, shots=8192) # simulator
...
def circuit(x1, x2):
	...
	qml.templates.MottonenStatePreparation(x2, wires=[4, 5, 6])
